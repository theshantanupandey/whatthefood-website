          ...
          <AnimatedSection animation="fade-in-right" className="relative">
            <div className="relative lg:-mr-12">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <img src="https://images.unsplash.com/photo-1484723091739-30a097e8f929?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Healthy meal preparation" className="w-full h-auto" />
              </div>
              ...
              <div className="absolute top-1/2 -right-12 transform -translate-y-1/2 bg-white rounded-2xl p-6 shadow-lg w-64">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="font-semibold">5:00 AM - 12:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
